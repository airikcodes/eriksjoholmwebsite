...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-10 h-14 bg-[#0A0A0A]">
      <Link
        href="/"
        className="font-[family-name:var(--font-cormorant)] font-light text-[#FAFAFA] hover:text-[#F59E0B] transition-colors duration-300"
